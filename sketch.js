...
function draw() {
  ...
  if(GAMESTATE === play_INSTRUCTION) {
    ...
    fill("light green")
    text("THANK U FOR USING SPACE HARRIER, TO PLAY THIS GAME U NEED A DESK, LAPTOP",width/7.5,height-height/1.7);
    text("TO MOVE YOUR SPACESHIP, USE YOUR ARROW KEYS. YOUR MAIN MOTO IS TO DESTROY , ",width/7.5,height-height/1.9);
    text("ALL THE SPACESHIP. HOW MUCH YOU CAN,BUT REMEMBER BE SAFE FROM ASTERIODS.",width/7.5,height-height/2.1)
    text("AND DONT FORGET THAT ENEMIES ARE NEVER GONNA STOP",width/4.5,height-height/2.4)
    text("SPACESHIP CAN ALSO SHOOT YOU CAN ALSO SHOOT BY PRESSING SPACEBAR...",width/7.5,height-height/2.80);
    text("FOR YOUR HELP THERE IS A FRIEND TO HELP YOU , BUT HE CAN ONLY HELP IN EAST DIRECTION...",width/9,height-height/3.40)
    text("COVER THE WESTERN BASE....SCORE AS GOOD AS YOU CAN.. AND DON'T FORGET TO HAVE FUN !!!",width/15.5,height-height/4.2)
    text("                                                                      THANK YOU..",width/7.5,height-height/5.5);
